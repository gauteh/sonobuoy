...
\begin{multicols}{2}
  ...
  \section{Data structure}
    ...
    \paragraph{} By convention most programs work with the integer
    shifted down to a range of 31 bits: $\left[ - 2^{30}, 2^{30} -1
      \right]$. This exceeds the real SNR by several magnitudes.
