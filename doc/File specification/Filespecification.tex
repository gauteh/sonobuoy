...
\begin{multicols}{2}
  ...
  \section{Data structure}
    ...
    \begin{tabular}{|l|l|}
      ...
      \bfseries Bit & \bfseries Flag \\ \hline
       ...
       0b1  &   Time    \\ \hline
       0b10 &   Sync    \\ \hline
       0b100 &  Sync Reference \\ \hline
       0b1000 & Position \\ \hline
    \end{tabular}
    \captionof{table}{Status flag bit mapping}
    \label{tab:status_flags}

    \paragraph{Time} Means that a valid time is provided by the GPS
    unit.
    \paragraph{Sync} Means that the PPS signal is being sent and the
    timing can be determined accurately.

    \paragraph{Sync reference} Means that the reference in use was
    ...
    \paragraph{Position} Means that the GPS is delivering a valid
    position fix.
  ...
  \begin{tabular}{|r|c|c|l|}
    ...
    \bfseries Start   &     \bfseries Field     &   \bfseries Type
    &   \bfseries Size  \\ \hline
    0   & Padding   & 0   & $3 \cdot \text{sample length} = 12 $ \\ \hline
    ...
    56  & Padding   & 0   & $3 \cdot \text{sample length} = 12 $ \\ \hline
  ...
  The reference is padded in both ends so that it will be easier to
  ...
  \begin{enumerate}
    ...
    \item HasFull, 'True' or 'False', whether the complete file has been
     received.
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Comma separated list of finished chunks (integers)
  \end{enumerate}
  ...
  should be one 0 in the last comma separated list.
