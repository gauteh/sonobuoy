...
higher corner frequency is at $f_{HP} = 17.189 $ kHz. The corner
frequency is well above the band of interest ($< 1$ kHz), but should
provide sufficient damping at the Nyquist frequency of the digitizer
which has a modulator speed of ca $f_{clk}/4 = 4\ \text{MHz} / 4 = 1\ 
\text{Mhz}$ \cite{ads1282_ds}.
