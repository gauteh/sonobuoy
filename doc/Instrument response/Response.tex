...
amplifiers) in the signal path, first the OPA629 \cite{opa629_ds} acting as buffer with
unity gain and then the OPA1632 \cite{opa1632_ds} at the ADS1282EVM \cite{ads1282evm_ds}.
...
The 10 nF capacitor utilized on the ADS1282EVM
\cite{ads1282evm_ds}, creates in a low-pass filter with an upper corner frequency of $f_{LP_2} =
