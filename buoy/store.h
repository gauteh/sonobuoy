...
# define MAX_SAMPLES_PER_FILE (EST_SAMPLE_RATE * 60uL * EST_MINUTES_PER_DATAFILE)
# define MAX_REFERENCES ((MAX_SAMPLES_PER_FILE / ( EST_SAMPLE_RATE * ROLL_REFERENCE)) + 20uL)
